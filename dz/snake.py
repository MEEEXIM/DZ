...
speed = 50
dataRead = open("file_snake.json","r").read()
file = json.loads(dataRead)
move_snake = file['move_snake']
move_snake_old = file['move_snake_old']
...
arr_move_snake_number = [
     {
     "move_snake_number_x" : file['x1'],
     "move_snake_number_y" : file['y1'],
},
]
